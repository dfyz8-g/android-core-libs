# android-network
Networking library for Android built with [Hilt](https://dagger.dev/hilt/), [Retrofit](https://square.github.io/retrofit/) and [Scarlet](https://github.com/Tinder/Scarlet).

### Specs
[![](https://jitpack.io/v/cren90/android-network.svg)](https://jitpack.io/#cren90/android-network) [![API](https://img.shields.io/badge/API-16%2B-orange.svg?style=flat)](https://android-arsenal.com/api?level=16) [![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
